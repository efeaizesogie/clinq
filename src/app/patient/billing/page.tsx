...
export default function BillingPage() {
  return (
    <div className="p-6 min-h-screen bg-[#F8F9FF] dark:bg-[#080F18] font-[Manrope,sans-serif] text-[#42474F] dark:text-[#A5AAB5] transition-colors duration-300">
      <div className="flex gap-8 items-start">
        ...
        <div className="flex flex-col gap-8 flex-1 min-w-0">
          ...
          <div
            className="relative rounded-lg overflow-hidden bg-[#0F4C81] dark:bg-[#121E2C] border dark:border-[#22354A] transition-colors"
            style={{ padding: '52px 32px', minHeight: 220 }}
          >
            {/* Blur blob */}
            <div
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div className="flex flex-col gap-1">
                ...
                <div className="mt-1">
                  ...
                  <p className="text-white dark:text-[#A5AAB5] text-base transition-colors pages_font">Next due date: October 24, 2023</p>
                </div>
              </div>
              <div className="flex gap-4 items-center">
                <button className="bg-white dark:bg-[#1B6CA8] hover:bg-[#EFF4FF] dark:hover:bg-[#2582C7] text-[#00355F] dark:text-white font-bold text-base px-8 py-3 rounded-xl transition-colors cursor-pointer">
                  Pay Now
                </button>
                <button className="border border-white dark:border-[#22354A] text-white dark:text-[#A5AAB5] hover:bg-white/10 dark:hover:bg-white/5 font-bold text-base px-8 py-3 rounded-xl transition-colors cursor-pointer">
                  View Plan
                </button>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-[#121E2C] border border-[#C2C7D1] dark:border-[#22354A] rounded-lg shadow-[0_4px_20px_rgba(15,76,129,0.04)] dark:shadow-none overflow-hidden transition-colors">
            {/* Table Header */}
            <div
              className="flex items-center justify-between px-6 py-4 border-b border-[#C2C7D1] dark:border-[#22354A] bg-[#EFF4FF]/30 dark:bg-[#1E2D4A]/30 transition-colors"
            >
              <h2 className="text-[#00355F] dark:text-[#5F9EA0] font-semibold text-lg transition-colors">Payment History</h2>
            ...
            {/* Column Headers */}
            <div className="w-full bg-[#EFF4FF]/50 dark:bg-[#1E2D4A]/50 transition-colors">
            ...
            <div>
              {payments.map((row, i) => (
                ...
                >
                  <div className="px-6 py-4 text-[#0D1C2E] dark:text-white text-base transition-colors">{row.date}</div>
                  <div className="px-6 py-4 text-[#0D1C2E] dark:text-white text-base transition-colors">{row.service}</div>
                  <div className="px-6 py-4 text-[#0D1C2E] dark:text-white text-base transition-colors">{row.amount}</div>
        ...
        <div className="flex flex-col gap-8 w-[304px] shrink-0">
          ...
          {/* Payment Methods */}
          <div className="bg-white dark:bg-[#121E2C] border border-[#C2C7D1] dark:border-[#22354A] rounded-lg shadow-[0_4px_20px_rgba(15,76,129,0.04)] dark:shadow-none p-6 flex flex-col gap-6 transition-colors">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="border border-[#C2C7D1] dark:border-[#22354A] rounded-lg p-4 flex items-center gap-4 transition-colors">
                ...
                <div>
                  <p className="text-[#0D1C2E] dark:text-white font-bold text-base leading-6 transition-colors font-sans">Visa ending in 4242</p>
              ...
              >
                ...
                <div>
                  <p className="text-[#0D1C2E] dark:text-white font-bold text-base leading-6 transition-colors font-sans">Chase Checking</p>
          ...
          {/* Insurance */}
          <div className="bg-white dark:bg-[#121E2C] border border-[#C2C7D1] dark:border-[#22354A] rounded-lg shadow-[0_4px_20px_rgba(15,76,129,0.04)] dark:shadow-none p-6 flex flex-col gap-4 transition-colors">
            <h2 className="text-[#00355F] dark:text-[#5F9EA0] font-semibold text-2xl transition-colors font-sans">Insurance</h2>

            {/* Digital Insurance Card */}
            <div
              className="relative rounded-lg overflow-hidden p-8 flex flex-col gap-10 bg-gradient-to-br from-[#00355F] to-[#0F4C81] dark:from-[#1E2D4A] dark:to-[#1E2D4A]/70 border dark:border-[#22354A] min-h-[248px] transition-colors"
            >
              {/* Texture overlay */}
              ...
              <div className="relative z-10 flex justify-between items-start">
                <div>
                  ...
                  <p className="text-white font-bold text-lg leading-8 mt-1 font-sans">Blue Cross<br />Blue Shield</p>
                </div>
              ...
              <div className="relative z-10 flex gap-4">
                <div>
                  ...
                  <p className="text-white font-bold text-base leading-6 mt-1 font-sans">ABC123456789</p>
                </div>
                <div>
                  <p className="text-white text-xs font-semibold tracking-[0.6px] opacity-60">Group Number</p>
                  <p className="text-white font-bold text-base leading-6 mt-1 font-sans">GRP90021</p>
                </div>
              </div>
            </div>

            <button className="w-full border border-[#00355F] dark:border-[#1B6CA8] text-[#00355F] dark:text-[#1B6CA8] hover:bg-gray-50 dark:hover:bg-white/5 font-bold text-base py-3 rounded-xl transition-all cursor-pointer">
              Upload New Card
            </button>
          ...
          {/* Billing Support */}
          <div className="bg-[#EFF4FF] dark:bg-[#121E2C] border border-[#C2C7D1] dark:border-[#22354A] rounded-lg shadow-[0_4px_20px_rgba(15,76,129,0.04)] dark:shadow-none p-6 flex items-center gap-4 transition-colors">
            ...
            <div>
              <p className="text-[#00355F] dark:text-[#5F9EA0] font-bold text-base transition-colors">Need Billing Help?</p>
              ...
              <p className="text-[#00355F] dark:text-[#1B6CA8] font-bold text-base mt-1 transition-colors">1-800-CLINQ-MED</p>
            </div>
          </div>
