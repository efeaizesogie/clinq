...
import { 
  ...
  ShieldCheck, Heart, ClipboardCheck
} from 'lucide-react';
      ...
      <main className="w-full flex flex-col items-start pt-[81px] bg-brand-bg-light">
        ...
        <section className="w-full bg-white py-8 md:py-[128px] px-6 md:px-16 flex items-center justify-center border-b border-[#C2C7D1]/10">
          <div className="w-full max-w-[1152px] flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="w-full md:w-[512px] flex justify-center order-2">
              <img src="/hero-img.svg" alt="clinq patient dashboard illustration" className="max-w-[320px] sm:max-w-[400px] md:max-w-none w-full h-auto" />
            </div>
        ...
        <section className="w-full bg-white py-12 md:py-20 border-b border-t border-[#C2C7D1]/10 flex justify-center">
          <div className="w-full max-w-[1280px] px-6 md:px-16 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center gap-1 text-center">
              <div className="text-2xl sm:text-[32px] font-[600] leading-10 text-brand-blue tracking-[-0.32px]">99%</div>
              <div className="text-[10px] sm:text-xs font-[600] text-[#42474F] tracking-[0.6px] uppercase">Satisfaction</div>
            </div>

            <div className="flex flex-col items-center gap-1 text-center">
              <div className="text-2xl sm:text-[32px] font-[600] leading-10 text-brand-blue tracking-[-0.32px]">24/7</div>
              <div className="text-[10px] sm:text-xs font-[600] text-[#42474F] tracking-[0.6px] uppercase">Hours Support</div>
            </div>
        ...
        <section className="w-full bg-white py-12 border-b border-[#C2C7D1]/10 flex justify-center">
          <div className="w-full max-w-[1152px] px-6 flex flex-col gap-8 items-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 bg-white min-h-7 text-center">
              <span className="text-base sm:text-xl font-[700] text-[#42474F]">Aetna</span>
              <span className="text-base sm:text-xl font-[700] text-[#42474F]">BlueCross</span>
              <span className="text-base sm:text-xl font-[700] text-[#42474F]">UnitedHealthcare</span>
              <span className="text-base sm:text-xl font-[700] text-[#42474F]">Cigna</span>
              <span className="text-base sm:text-xl font-[700] text-[#42474F]">Axa</span>
              <span className="text-base sm:text-xl font-[700] text-[#42474F]">Medicare</span>
            </div>
        ...
        <section className="w-full bg-white py-12 md:py-[68px] px-6 md:px-16 flex justify-center border-b border-[#C2C7D1]/10">
          <div className="w-full max-w-[1152px] flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
            ...
            <div className="w-full md:w-auto flex justify-center">
              <img src="/advanced-tool.svg" alt="clinq advanced diagnostic tools" className="max-w-[320px] sm:max-w-[400px] md:max-w-none w-full h-auto" />
            </div>
            ...
            <div className="flex flex-col gap-4 w-full">
              {faqs.map((faq, idx) => (
                ...
                >
                  ...
                  >
                    <span>{faq.q}</span>
                    <ChevronDown className={`w-4 h-4 text-brand-dark transition-transform shrink-0 ${activeFaq === idx ? 'rotate-180' : ''}`} />
                  </button>
                  {activeFaq === idx && (
          ...
          <div className="w-full max-w-[1024px] flex flex-col gap-12 md:gap-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
              ...
              <div className="flex flex-col items-center text-center gap-2">
                ...
                <h4 className="text-xl sm:text-2xl font-[600] text-white">Active Specialists</h4>
              ...
              <div className="flex flex-col items-center text-center gap-2">
                ...
                <h4 className="text-xl sm:text-2xl font-[600] text-white">Total Consultations</h4>
                <p className="text-xs sm:text-sm text-white/70 leading-5">
              ...
              <div className="flex flex-col items-center text-center gap-2">
                ...
                <h4 className="text-xl sm:text-2xl font-[600] text-white">Satisfaction Rate</h4>
                <p className="text-xs sm:text-sm text-white/70 leading-5">
        ...
        <section className="w-full bg-[#F8F9FF] py-16 md:py-[128px] px-6 md:px-16 flex justify-center border-b border-[#C2C7D1]/10">
          <div className="w-full max-w-[1152px] flex flex-col gap-12 md:gap-16">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 w-full">
              ...
              <Link href="/resources" className="text-sm sm:text-base font-[700] text-brand-blue flex items-center gap-1 hover:underline">
        ...
        <section id="specialists-section" className="w-full bg-[#EFF4FF] py-16 md:py-[128px] px-6 md:px-16 flex justify-center">
                    ...
                    filteredDoctors.map((doc) => (
                      ...
                      >
                        ...
                        <div className="flex-1 flex flex-col items-start gap-0.5">
                          <h4 className="text-sm sm:text-base font-[700] text-brand-dark">{doc.full_name}</h4>
                          <span className="text-xs sm:text-sm text-[#42474F] font-[400]">{doc.specialty}</span>
                        </div>
                        <Link 
                          href="/patient/appointments/book"
        ...
        <section className="w-full bg-white py-16 md:py-[128px] px-6 md:px-16 flex justify-center border-b border-[#C2C7D1]/10">
          <div className="w-full max-w-[1152px] flex flex-col md:flex-row items-center justify-between gap-12 md:gap-20">
            ...
            <div className="w-full md:w-auto flex justify-center">
              <img src="/appointment-booked.svg" alt="clinq mobile appointment confirmation" className="max-w-[280px] sm:max-w-[360px] md:max-w-[#450px] w-full h-auto" />
            </div>
            ...
            <div className="w-full lg:w-[551px] flex flex-col justify-center items-start gap-6 relative z-10 text-left">
              ...
              <dl className="flex flex-col gap-6 pt-2 w-full text-sm">
                ...
                <div className="flex flex-row items-start gap-4">
                  ...
                  <div>
                    <dt className="font-[700] text-brand-dark text-sm sm:text-base">Main Campus Address</dt>
                    <dd className="text-xs sm:text-sm text-[#42474F] mt-0.5">123 Healthcare Blvd, Medical District</dd>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-start gap-4">
                  ...
                  <div>
                    <dt className="font-[700] text-brand-dark text-sm sm:text-base">Contact Telephone Line</dt>
                    <dd className="text-xs sm:text-sm text-[#42474F] mt-0.5">+1 (555) 019-2834</dd>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-start gap-4">
                  ...
                  <div>
                    <dt className="font-[700] text-brand-dark text-sm sm:text-base">Electronic Communications Mail</dt>
                    <dd className="text-xs sm:text-sm text-[#42474F] mt-0.5">info@clinq.healthcare</dd>
                  </div>
                </div>
