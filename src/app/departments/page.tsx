  ...
  return (
    <div className="flex flex-col items-center w-full bg-brand-bg-light relative min-h-screen font-sans antialiased text-[#42474F]">
      ...
      <main className="w-full bg-[#F8F9FF] flex flex-col justify-start items-center relative pt-[81px]">
        ...
        <section className="w-full bg-[#EFF4FF] py-[128px] border-b border-[#C2C7D1]/10 flex justify-center h-[411px] shrink-0">
          <div className="w-[1152px] flex flex-col items-center justify-center gap-6 text-center">
            <h1 className="text-[48px] leading-[56px] font-[700] text-brand-blue tracking-[-0.96px]">
        ...
        {/* =============== SEARCH & GRID SECTION (Centered Content) =============== */}
        <section className="w-full py-[128px] flex justify-center min-h-[824px] bg-[#F8F9FF]">
          <div className="w-[1152px] flex flex-col gap-16">
            
            {/* Search bar & Dropdown Filters row */}
            <div className="w-full flex justify-between items-center h-[50px] gap-8">
              
              {/* Input Left */}
              <div className="w-[384px] h-[50px] relative">
              ...
              <div className="relative z-30">
                <button 
                  ...
                  className="w-[220px] h-[50px] bg-white border border-[#C2C7D1] rounded-[8px] px-4 flex justify-between items-center cursor-pointer text-sm font-[600] text-[#42474F] focus:outline-none focus:ring-2 focus:ring-brand-blue/20"
                >
                ...
                {isDropdownOpen && (
                  <div className="absolute top-[56px] right-0 w-[220px] bg-white border border-[#C2C7D1]/30 rounded-[8px] shadow-lg flex flex-col overflow-hidden">
                    {['All', 'Primary Care', 'Specialty', 'Clinical'].map((filter) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-left text-xs font-[600] transition ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
              {filteredDepts.length > 0 ? (
                filteredDepts.map((dept) => (
                  <div 
                    key={dept.id}
                    className="bg-white border border-[#C2C7D1]/50 rounded-[8px] p-8 flex flex-col gap-3 h-[343px] shadow-sm hover:shadow-md transition duration-200"
                  >
                    {/* Icon Block */}
                    ...
                    {/* Title */}
                    <h3 className="text-[24px] leading-[32px] font-[600] text-brand-blue pt-3">
                      {dept.name}
                    </h3>

                    {/* Description */}
                    <p className="text-[16px] leading-[24px] font-[400] text-[#42474F] h-[72px] overflow-hidden ellipsis">
                      {dept.description}
                    </p>

                    {/* Divider and Details Row */}
                    <div className="border-t border-[#C2C7D1]/30 pt-6 mt-auto flex justify-between items-center text-xs">
        ...
        {/* =============== CTA HOTLINE BANNER (Full Width Background) =============== */}
        <section className="w-full bg-[#00355F] py-20 flex justify-center text-white h-[378px] shrink-0">
          <div className="w-[1152px] flex flex-col gap-6 items-center text-center">
            
            <h2 className="text-[24px] font-[600] text-white tracking-[-0.32px]">
              Need Immediate Assistance?
            </h2>

            <p className="text-base text-white/80 leading-[28px] max-w-[588px]">
            ...
            <div className="flex items-center gap-4 pt-4">
              <a 
                href="tel:911"
                className="px-10 py-[17px] h-[58px] bg-white text-brand-blue font-[700] text-[16px] leading-[24px] rounded-lg shadow-sm flex items-center justify-center hover:bg-white/90 transition"
              >
                Call Emergency 911
              </a>
              <Link 
                href="/support"
                className="px-10 py-4 h-[58px] bg-[#0F4C81]/40 border border-white/30 text-white font-[700] text-[16px] rounded-lg flex items-center justify-center hover:bg-white/5 transition"
              >
                Contact Us
              </Link>
            </div>
        ...
        {/* =============== GETTING READY FOR YOUR VISIT (Contrasting Light Section) =============== */}
        <section className="w-full bg-white py-20 flex justify-center border-t border-b border-[#C2C7D1]/10">
          <div className="w-[1152px] flex flex-col gap-12 items-center">
            
            <div className="flex flex-col items-center gap-4 text-center">
              <h2 className="text-[24px] font-[600] text-[#00355F] tracking-[-0.32px]">
            ...
            <div className="flex flex-row justify-between items-start gap-8 w-full">
              ...
              {/* Step 1 */}
              <div className="flex-1 bg-[#F8F9FF] border border-[#C2C7D1]/20 rounded-lg p-8 flex flex-col gap-3 min-h-[220px]">
                ...
                <h3 className="text-lg font-[600] text-brand-blue mt-2">
                  1. Mapped Specialists
                </h3>
                <p className="text-xs text-[#42474F] leading-5">
      ...
      {/* Global Footer (Full Width parent background inside itself) */}
      <PublicFooter />
